...
export default {
    ...
    setup() {
        ...
        const submitRatings = () => {
            confirm.require({
                message: 'Are you sure you want to rate this room?',
                header: 'Confirmation',
                ...
                accept: () => {
                    axios.post(route("tenant.rate.dorm"),
                        ...
                        .then((response) => {
                            toast.add({ severity: 'info', summary: 'Confirmed', detail: 'Successfully add rating', life: 3000 });
                            setTimeout(function () {
                                location.reload();
                            }, 3000);
                        })
        ...
        const submitComplain = () => {
            confirm.require({
                message: 'Are you sure you want to submit this complain?',
                header: 'Confirmation',
                icon: 'fa-solid fa-triangle-exclamation',
                accept: () => {
    ...
    <AuthenticatedLayout v-if="user.status == 'approved'">
        ...
        <div class="min-w-screen
                ...
                <div class="mt-10" v-if="myDorm">
                    ...
                    <div
                        className="grid grid-cols-3 w-full mt-5 gap-8"
                    >
                        <div class="col-span-2">
                                <img
                                    :src="myDorm.dorm.dorm_image"
                                    class="rounded-md w-full shadow-md"
                                    height="404"
                                />
                        </div>
                        <Card class="" >
                    ...
                    <div class="h-screen flex justify-center items-center">
                        <div class="relative w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                >
                                    <button
                                        @click.prevent="submitComplain(), closeComplainModal()"
                                        type="button"
