...
export default {
    ...
    setup() {
        ...
        const viewRooms = (id) => {
            router.get(route('tenant.reservation', id));
        }
...
<template>
    <SidebarLayout>
        <div class="p-4 mt-20 lg:ml-64">
            <p class="text-4xl mb-5 font-bold">My Reservations</p>
                    ...
                    > 
                        <Card style="width: 30em; cursor: pointer;" >
                            <template #header>
                                <img
                                    alt="user header"
                                    :src="reser.room.image"
                                    class="h-[300px] w-full rounded-t-lg"
                                    @click="viewRooms(reser.id)"
                                />
                            </template>
                            <template #title>
                                {{ reser.room.name }}
                                <p class="text-lg">
                                    ₱ {{ parseFloat(reser.room.fee).toFixed(2) }}/ a
                                    month
                                </p>
                            </template>
                            <template #content class="py-1">
                                <div class="font-light">
                                    Dorm Name:
                                    <span>{{ reser.dorm.property_name }}</span>
                                </div>
                                ...
                                <div class="font-semibold">
                                    ...
                                    <span class="font-light">
                                        ₱
                                        {{
                                            parseFloat(reser.room.advance).toFixed(2)
                                        }}
                                    </span>
                                </div>
                                <div class="font-semibold">
