...
<template>
    <div>
        ...
        <img 
            ...
            />
        <div
            class="absolute inset-0 h-[400px] rounded-2xl bg-black bg-opacity-50"
        ></div>
        <div class="relative flex flex-col items-center justify-center mt-40">
            ...
            >
                ...
                <i class="fa-brands fa-facebook fa-lg" style="color: #ffffff;"></i>
                    <p class="hover:text-orange-400 cursor-pointer">
                        {{ contactUs.facebook}}
                    </p>
                </div>
                <div
            ...
            <div class="mx-5 flex flex-row gap-4 mt-14 items-center justify-center">
                <div class="w-80">
                    ...
                    <div class="mb-6 last:mb-0">
                        ...
                        <div class="">
                            <div class="bg-white rounded-lg dark:bg-gray-800">
                                            ...
                                            <textarea v-model="message"  rows="6" class="block w-full p-3 text-sm text-gray-800 bg-gray-100  border-1 rounded-lg focus:ring-0 " placeholder="Write a Message..." required></textarea>
                                        </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-5 flex items-center justify-center mb-20">
                <button type="submit" class="px-3 py-2 text-white bg-orange-400 rounded-md">Send Message</button>
            </div>
