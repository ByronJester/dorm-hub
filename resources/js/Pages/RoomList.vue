...
<template>
    <SidebarLayout v-if="user">
        <div class="p-4  lg:ml-64">
            ...
            <hr class="mt-3"/>
            <div v-if="availableRooms.length < 1" class="w-full text-center bg-gray-400 py-2 text-white ">No Rooms Available</div>
            <div class="mb-10 grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 mx-3 mt-5 gap-2">
