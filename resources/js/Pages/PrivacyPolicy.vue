...
<template>
    <div>
        ...
        <div class="absolute rounded-2xl bg-cover h-[400px] bg-center bg-no-repeat inset-0 bg-[url(https://images.unsplash.com/photo-1604014237800-1c9102c219da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80)]"></div>
            <div class="absolute flex items-center justify-center inset-0 h-[400px] rounded-2xl bg-black bg-opacity-50">
                <div class="relative w-full mx-auto py-32 ">
                    <p class="text-white text-center text-3xl font-bold">Privacy Policy</p>
                </div>
            </div>

    <!-- Main Content -->
    <div class="relative mt-[400px] mx-5 py-8 px-10">
        <div v-html="policy.content" class="mx-auto bg-white p-6 rounded-lg">
