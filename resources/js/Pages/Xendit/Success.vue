...
<template>
    <AuthenticatedLayout>
        <div
            class="w-full flex items-center justify-center p-3 mt-16 text-white text-sm font-semibold bg-orange-400"
            v-if="dorm && dorm.status == 'pending'"
        >
            Your dormitory is on pending list! Wait for the system admin to
            verify your dorm! Thankyou
        </div>
        <div class="mt-5 mb-10 rid-rows mx-5">
            <div>
                <p class="text-center text-2xl mb-5 font-bold">Dorm Registration Completed Successfully!</p>
                <div
