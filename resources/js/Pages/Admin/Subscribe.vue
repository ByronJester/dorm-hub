...
export default {
    ...
    setup() {
        ...
        const subs = page.props.subscriber;
        console.log(subs)
                ...
                <div class="flex flex-row gap-20 mt-10 w-full">
                    <div class="flex-grow">
                        ...
                        <div class="card mb-10 mt-2">
                            <DataTable v-model:filters="filters" :value="subs" tableStyle="min-width: 30rem"
                                :rowsPerPageOptions="[5, 10, 20, 50]" class="border" paginator :rows="10"
                                :globalFilterFields="['name', 'subscription', 'created_at', 'amount', 'status']">
                                <template #header>
                                ...
                                <Column field="subscription" header="Subscription" sortable style="min-width: 14rem"
                                    class="border-b">
                                    <template #body="{ data }">
                                        {{ data.subscription }}
                                    </template>
                                </Column>
                                <Column field="created_at" header="Date Subscribed" sortable dataType="date"
                                    style="min-width: 10rem" class="border-b">
                                    <template #body="{ data }">
