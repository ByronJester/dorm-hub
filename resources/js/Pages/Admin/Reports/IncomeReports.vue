...
export default {
    ...
    setup() {
        ...
        const header=["Dorm Name", "Owner Name", "Address", "Contact No.", "Status", "Net Sales"]
        const data = [
            ["Panganiban's Dorm", "Pastora Panganiban", "Caloocan, Balayan", "09165984951", "Approved", 300],
            ["Roxas Dorm", "Ronnel Roxas", "Caloocan, Balayan", "09165984951", "Approved", 300],
            ["M.D.R Apartment", "Marife De Guzman", "Caloocan, Balayan", "09165984951", "Approved", 300],
            ["M.D.R Apartment 2", "Marife De Guzman", "Caloocan, Balayan", "09165984951", "Approved", 300],
