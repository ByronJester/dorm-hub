...
export default {
    ...
    setup() {
        ...
        const header=["Seeker Name", "Room Name", "Reservation Fee", "Reservation Expiry Date"]
        ...
        const data = page.props.reservationReports
        ...
        const exportToPDF = ()  => {
            ...
            doc.setFontSize(15);
            doc.text("Reseravtion Report", 15, 60)
            ...
            doc.save("reservation-report-" +timestamp+'.pdf');
        }
        return {
            date,
            presetDates,
...
<template>
     <div class="flex flex-row gap-2 items-center">
       ...
       <p class="text-2xl font-semibold my-4">Reservation Report</p>
   </div>
   <p class="text-lg  ">This report is typically used by dormitory managers or administrators to keep track of room occupancy, manage reservations, and plan for future occupancy. </p>
