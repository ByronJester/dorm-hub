...
export default {
    ...
    setup() {
        ...
        const header=["Room Name", "Tenant Name", "Monthly Rent", "Total Rent Collected"]
        const data = [
            ["Bedroom 1", "John Doe", "2000", "8000"],
            ["Bedroom 2", "Jane Smith", "4000", "12000"],
            ["Total", "", "", "20000"]
...
<template>
    <div class="flex flex-row gap-2 items-center">
        ...
        <p class="text-2xl font-semibold my-4">Rent Roll Report</p>
    </div>
